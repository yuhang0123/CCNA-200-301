...
- send DBD packets to each other
...
- neighbour routers return LSAs requested in Link State Update messages
...
- layer 2
- one side function as Data Communication Equipment (DCE); one side is Data Terminal Equipment (DTE)
...
3. Type 5 (AS External LSA)
    - generated by ASBDs to describe routers to destination outside of the AS